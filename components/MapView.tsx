...
const MapView: React.FC<MapViewProps> = ({ origin, plans, focusedPlanIndex, onPlanSelect }) => {
  ...
  return (
    <div 
      id={mapContainerId} 
      className="w-full h-full min-h-[460px] rounded-xl border border-slate-200 z-0 relative"
    />
  );
};
